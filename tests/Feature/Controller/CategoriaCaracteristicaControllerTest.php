...
class CategoriaCaracteristicaControllerTest extends TestCase
{
    ...
    public function test_list_categorias()
    {
        ...
        ])->get('/api/caracteristica/categoria/list');
    ...
    public function test_create_nova_categoria()
    {
        $response = $this->withHeaders([
            'Authorization' =>  $this->token,
        ])->post('/api/caracteristica/categoria',
            [
                'nome' => 'Categoria test'
            ]);
    ...
    public function test_busca_categoria_por_id()
    {
        $response = $this->withHeaders([
            'Authorization' =>  $this->token,
        ])->get('/api/caracteristica/categoria/' .$this->categoria->id);
    ...
    public function test_busca_categoria_por_id_not_exits()
    {
        $response = $this->withHeaders([
            'Authorization' =>  $this->token,
        ])->get('/api/caracteristica/categoria/2');
    ...
    public function test_atualizar_categoria()
    {
        $response = $this->withHeaders([
            'Authorization' =>  $this->token,
        ])->patch('/api/caracteristica/categoria',
            [
    ...
    public function test_delete_categoria_caracteristica_id_vinculado()
    {
        $response = $this->withHeaders([
            'Authorization' =>  $this->token,
        ])->delete('/api/caracteristica/categoria/' .$this->categoria->id);
    ...
    public function test_delete_categoria_caracteristica_id_invalido()
    {
        $response = $this->withHeaders([
            'Authorization' =>  $this->token,
        ])->delete('/api/caracteristica/categoria/100');
